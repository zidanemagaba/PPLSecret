...
public class CustomSa extends BaseAdapter {
    Context context;
    String[] matkul, kode, kelas, jadwal1, jadwal2, jadwal3, absen, dabsen;
    LayoutInflater inflter;

    public CustomSa(Context applicationContext, String[] matkul, String[] kode, String[] kelas, String[] jadwal1, String[] jadwal2, String[] jadwal3, String[] absen) {
