...
public class DataKrs extends AppCompatActivity {
    ...
    String[] id, matkul, kode, kelas, jadwal1, jadwal2, jadwal3, absen, dabsen;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            Toast.makeText(DataKrs.this, "Eror "+e,Toast.LENGTH_LONG).show();
                        }
                    }
                },
    ...
    private void iniData(String response){
        try {
            ...
            if(status.equals("1")){
                AlertDialog.Builder builder = new AlertDialog.Builder(DataKrs.this);
                ...
                builder.setPositiveButton("Oke", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int j) {
                        startActivity(new Intent(DataKrs.this, Login2Activity.class));
                        finish();
                    }
                });
                ...
                for(int i=0; i<jsonArray.length(); i++){
                    ...
                    kode[i]= b+" ["+d+" Sks]\nSemester "+p;
                    kelas[i]= "Kelompok "+e;
                    if(g.equals("KRS Anda belum diverifikasi Dosen Wali")){ jadwal1[i]= g; }else{ jadwal1[i]= g+" ("+h+")"; }
                    if(j.equals("")||j.equals("-")){ jadwal2[i]= j; }else{ jadwal2[i]= j+" ("+k+")"; }
                    if(l.equals("")||l.equals("-")){ jadwal3[i]= l; }else{ jadwal3[i]= l+" ("+m+")"; }
                    /*jadwal1[i]= g+" ("+h+")";
                    jadwal2[i]= j+" ("+k+")";
                    jadwal3[i]= l+" ("+m+")";*/
                    absen[i]= n; dabsen[i]=o;


                }


                Intent i = new Intent(DataKrs.this, KrsActivity.class);
                i.putExtra("id", id);
